...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 11. Jan 2024 um 17:10
...
--
-- Tabellenstruktur für Tabelle `tbl_dozent_löschen`
--

CREATE TABLE `tbl_dozent_löschen` (
  `PK_Dozent_löschen` int(11) NOT NULL,
  `Vorname` varchar(90) DEFAULT NULL,
  `Nachname` varchar(90) DEFAULT NULL,
  `Anrede` varchar(9) DEFAULT NULL,
  `Kuerzel` varchar(5) DEFAULT NULL,
...
--
-- Tabellenstruktur für Tabelle `tbl_teilnehmer_löschen`
--

CREATE TABLE `tbl_teilnehmer_löschen` (
  `PK_Teilnehmer_löschen` int(11) NOT NULL,
...
--
-- Indizes für die Tabelle `tbl_dozent_löschen`
--
ALTER TABLE `tbl_dozent_löschen`
  ADD PRIMARY KEY (`PK_Dozent_löschen`);
...
--
-- Indizes für die Tabelle `tbl_teilnehmer_löschen`
--
ALTER TABLE `tbl_teilnehmer_löschen`
  ADD PRIMARY KEY (`PK_Teilnehmer_löschen`);
...
--
ALTER TABLE `tbl_kurs_dozent`
  ADD CONSTRAINT `tbl_kurs_dozent_ibfk_1` FOREIGN KEY (`FK_Dozent`) REFERENCES `tbl_dozent` (`PK_Dozent`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_kurs_dozent_ibfk_2` FOREIGN KEY (`FK_Kurs`) REFERENCES `tbl_kurs` (`PK_Kurs`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `tbl_kurs_teilnehmer`
--
ALTER TABLE `tbl_kurs_teilnehmer`
  ADD CONSTRAINT `tbl_kurs_teilnehmer_ibfk_1` FOREIGN KEY (`FK_Kurs`) REFERENCES `tbl_kurs` (`PK_Kurs`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_kurs_teilnehmer_ibfk_2` FOREIGN KEY (`FK_Teilnehmer`) REFERENCES `tbl_teilnehmer` (`PK_Teilnehmer`) ON DELETE CASCADE;
