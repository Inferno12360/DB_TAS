...
<?php
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        echo "<tr>
                <td>{$row['Teilnehmer_Teilnehmer']}</td>
                ...
                <td>
                        <form method='post' action='TeilnehmerinLöschen.php'>
                            <button type='submit' value='{$row['Teilnehmer_Teilnehmer']}' name='Teilnehmer_Teilnehmer'>Teilnehmer Löschen</button>
                        </form>
                    </td>
                <td>
                        <form method='post' action='RechnungErstellen.php'>
                            <button type='submit' name='Rechnung' value='{$row['Teilnehmer_Teilnehmer']}'>Rechnung Erstellen</button>
                        </form>
                    </td>
              </tr>";
    }
